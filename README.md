...
| [doc/vim.md](doc/vim.md) | Vim / gVim設定、out-of-store symlink、secret (SOPS) 管理、`hm-vim-secrets`、vim-plug、SKK辞書 (eskk) |
| [doc/nodejs.md](doc/nodejs.md) | Node.js / npm設定、npm global、nvm共存 |
